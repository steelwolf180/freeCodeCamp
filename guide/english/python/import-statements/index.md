...
import mypkg.sibling # Standard library modules
from mypkg import sibling # Related third-party modules
from mypkg.sibling import example # Local modules within the project
```
